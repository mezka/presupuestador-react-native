...
export const UPDATE_CLIENT_REQUESTED = 'UPDATE_ESTIMATE_REQUESTED';
export const UPDATE_CLIENT_PENDING = 'UPDATE_ESTIMATE_PENDING';
export const UPDATE_CLIENT_SUCCEDED = 'UPDATE_ESTIMATE_SUCCEDED';
export const UPDATE_CLIENT_FAILED = 'UPDATE_ESTIMATE_FAILED';
